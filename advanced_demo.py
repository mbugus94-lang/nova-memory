...
from core.agent_messaging import (
    get_message_broker, create_message, send_message, 
    broadcast_event, MessageType, MessagePriority
)
...
def demo_semantic_search():
    ...
    print(f"✓ Semantic search for 'What is the weather like?'")
...
def demo_jwt_authentication():
    ...
    print(f"✓ Generated token for MANAGER role")
